    ...
    <div class="footer-inner">
      ...
      <div class="footer-col">
        ...
        <div class="footer-contact-item">
          <a href="tel:07788258843">07788 258843</a>
        </div>
        <div class="footer-contact-item">
          <a href="mailto:james.eyles@vernwell.co.uk">james.eyles@vernwell.co.uk</a>
        </div>
        <div class="footer-contact-item">Malvern, Worcestershire</div>
        <div style="margin-top:14px">
          <a href="https://uk.linkedin.com/in/james-eyles-acma-44282033" target="_blank" rel="noopener" class="linkedin-icon">
